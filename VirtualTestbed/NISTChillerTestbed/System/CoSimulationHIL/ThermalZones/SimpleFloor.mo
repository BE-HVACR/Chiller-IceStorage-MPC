within VirtualTestbed.NISTChillerTestbed.System.CoSimulationHIL.ThermalZones;
model SimpleFloor "Model of a floor of the building"
  ...
  SimpleZone sou(
    ...
    AFlo=532.47/hRoo,
    hRoo=hRoo,
    m_flow_nominal=m_flow_nominal_sou,
    nPorts=2)                      "South zone"
  ...
  SimpleZone eas(
    ...
    AFlo=86.24/hRoo,
    hRoo=hRoo,
    m_flow_nominal=m_flow_nominal_eas,
    nPorts=2)                      "East zone"
  ...
  SimpleZone cor(
    ...
    AFlo=86.38/hRoo,
    hRoo=hRoo,
    m_flow_nominal=m_flow_nominal_cor,
    nPorts=2)                      "Core zone"
  ...
  SimpleZone nor(
    ...
    AFlo=118.25/hRoo,
    hRoo=hRoo,
    m_flow_nominal=m_flow_nominal_nor,
    nPorts=2)
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal_nor=nor.AFlo*nor.hRoo*
      1.2/3600 "Nominal mass flow rate";
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal_cor=cor.AFlo*cor.hRoo*
      1.2/3600 "Nominal mass flow rate";
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal_sou=sou.AFlo*sou.hRoo*
      1.2/3600 "Nominal mass flow rate";
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal_eas=eas.AFlo*eas.hRoo*
      1.2/3600 "Nominal mass flow rate";
equation
