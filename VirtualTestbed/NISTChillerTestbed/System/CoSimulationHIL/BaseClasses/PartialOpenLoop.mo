within VirtualTestbed.NISTChillerTestbed.System.CoSimulationHIL.BaseClasses;
partial model PartialOpenLoop
  ...
  parameter Modelica.SIunits.MassFlowRate mSou_flow_nominal=2.7*VRooSou*conv
    "Design mass flow rate perimeter 1";
  parameter Modelica.SIunits.MassFlowRate mEas_flow_nominal=6*VRooEas*conv
    "Design mass flow rate perimeter 2";
  parameter Modelica.SIunits.MassFlowRate mNor_flow_nominal=9*VRooNor*conv
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  CoSimulationHIL.ThermalZones.VAVBranch cor(
  ...
  CoSimulationHIL.ThermalZones.VAVBranch sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  CoSimulationHIL.ThermalZones.VAVBranch eas(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  CoSimulationHIL.ThermalZones.VAVBranch nor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupNor_flow(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={1100,132})));
  CoSimulationHIL.BaseClasses.MixingBox eco(
    redeclare package Medium = MediumA,
