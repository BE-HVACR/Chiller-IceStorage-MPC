within VirtualTestbed.NISTChillerTestbed.System.FakeSystem.Controls;
model ModeSelector "Finite State Machine for the operational modes"
  ...
  State unOccOff(
    mode=FakeSystem.Controls.OperationModes.unoccupiedOff,
    nIn=3,
    nOut=4) "Unoccupied off mode, no coil protection"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  State unOccNigSetBac(
    nOut=2,
    mode=FakeSystem.Controls.OperationModes.unoccupiedNightSetBack,
  ...
  State morWarUp(
    mode=FakeSystem.Controls.OperationModes.unoccupiedWarmUp,
    nIn=2,
  ...
  State occ(mode=FakeSystem.Controls.OperationModes.occupied, nIn=3)
    "Occupied mode"
  ...
  State morPreCoo(
    nIn=1,
    mode=FakeSystem.Controls.OperationModes.unoccupiedPreCool,
