within VirtualTestbed.NISTChillerTestbed.PerformanceData;
record Chiller1 =
  Buildings.Fluid.Chillers.Data.ElectricEIR.Generic (
    QEva_flow_nominal =  -45300,
    COP_nominal =         4.254,
    PLRMin =              0.10,
    PLRMinUnl =           0.10,
    PLRMax =              1.15,
    ...
    capFunT =             {0.7252,0.0003532,-0.0001927,-0.01164,0.0001463,0.0006738},
