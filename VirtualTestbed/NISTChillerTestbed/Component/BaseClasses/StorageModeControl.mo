within VirtualTestbed.NISTChillerTestbed.Component.BaseClasses;
model StorageModeControl "Storage mode controller"
  ...
  Modelica.StateGraph.Transition dorToCha(
    condition=u == Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Charging)
  ...
  Modelica.StateGraph.Transition chaToDis(
    condition=u == Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging)
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntCha(
    final integerTrue=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Charging),
    final integerFalse=0)
    annotation (Placement(transformation(extent={{48,-10},{68,10}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntDis(
    final integerFalse=0,
    final integerTrue=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging))
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntDor(
    final integerTrue=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Dormant),
    final integerFalse=0)
