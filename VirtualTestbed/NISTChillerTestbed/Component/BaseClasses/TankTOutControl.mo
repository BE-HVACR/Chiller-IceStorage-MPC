...
model TankTOutControl "Storage outlet temperature control"
  ...
  Modelica.Blocks.Sources.IntegerExpression dorMod(y=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Dormant))
    "Dormant mode"
  ...
  Modelica.Blocks.Sources.IntegerExpression chaMod(y=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Charging))
    "Charging mode"
  ...
  Modelica.Blocks.Sources.IntegerExpression disMod(y=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging))
    "Discharging mode"
