...
model NormalizedChargingDischargingRate
  ...
  VirtualTestbed.NISTChillerTestbed.Component.BaseClasses.qStar qStaCha(
    n=nCha,
    coeff=coeffCha,
    dt=dtCha) annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  VirtualTestbed.NISTChillerTestbed.Component.BaseClasses.qStar qStaDisCha(
    n=nDisCha,
    coeff=coeffDisCha,
    dt=dtDisCha)
  ...
  Buildings.Controls.OBC.CDL.Integers.LessEqualThreshold    dorMod(
    threshold=
     Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Dormant))
    "Dormant mode"
    annotation (Placement(transformation(extent={{-70,80},{-50,100}})));
  Buildings.Controls.OBC.CDL.Integers.LessThreshold         chaMod(threshold=
        Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging))
    "Chargin mode"
