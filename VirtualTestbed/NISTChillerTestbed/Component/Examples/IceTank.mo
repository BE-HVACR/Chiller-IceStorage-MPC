within VirtualTestbed.NISTChillerTestbed.Component.Examples;
model IceTank
  ...
  VirtualTestbed.NISTChillerTestbed.Component.IceTank iceTan(
  ...
  Modelica.Blocks.Sources.IntegerTable mod(table=[
        0,Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Dormant);
        3600,Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Charging);
        7200,Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging)])
                  "Mode"
