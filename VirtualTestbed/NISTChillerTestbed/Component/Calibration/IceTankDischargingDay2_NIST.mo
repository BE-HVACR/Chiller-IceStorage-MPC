within VirtualTestbed.NISTChillerTestbed.Component.Calibration;
model IceTankDischargingDay2_NIST
  ...
  Modelica.Blocks.Sources.IntegerConstant
                                       mod(k=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging))
                  "Mode"
