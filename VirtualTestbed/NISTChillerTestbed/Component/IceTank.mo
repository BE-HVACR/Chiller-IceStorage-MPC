...
model IceTank
  ...
  VirtualTestbed.NISTChillerTestbed.Component.BaseClasses.NormalizedChargingDischargingRate norQSta(
    nCha=nCha,
    coeffCha=coeffCha,
    dtCha=dtCha,
    nDisCha=nDisCha,
  ...
  VirtualTestbed.NISTChillerTestbed.Component.BaseClasses.LMTDStar lmtdSta(
    TFre=TFre,
  ...
  Buildings.Controls.OBC.CDL.Integers.LessThreshold chaMod(
      threshold=Integer(VirtualTestbed.NISTChillerTestbed.Component.Types.IceThermalStorageMode.Discharging))
    "Charging mode"
