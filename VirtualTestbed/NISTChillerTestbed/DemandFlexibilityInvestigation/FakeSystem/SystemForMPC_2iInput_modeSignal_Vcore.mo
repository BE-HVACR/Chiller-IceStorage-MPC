...
model SystemForMPC_2iInput_modeSignal_Vcore
 ...
 // control settings
  ...
  Control.ModeControl_1b_modeSignal
                             modCon(waiTim=0) "Mode controller"
  ...
  Modelica.Blocks.Interfaces.RealInput yVAVCor "Voltage signal for VAV damper"
    annotation (Placement(transformation(extent={{466,46},{494,74}}),
        iconTransformation(extent={{-140,20},{-100,60}})));
  Modelica.Blocks.Interfaces.RealOutput VCor_flow_SI
    "Volume flow rate from port_a to port_b" annotation (Placement(
        transformation(extent={{600,138},{620,158}}), iconTransformation(extent
          ={{100,70},{120,90}})));
  Modelica.Blocks.Interfaces.RealOutput TDisCor_SI
    "Temperature of the passing fluid" annotation (Placement(transformation(
          extent={{600,96},{620,116}}), iconTransformation(extent={{100,40},{
            120,60}})));
equation
  ...
  connect(conAHU.ySupFanSpe, ufanSpe.u3) annotation (Line(points={{424,616.667},
          {456,616.667},{456,616},{488,616}}, color={0,0,127}));
  ...
  connect(uModActOcc.y, booRep.u) annotation (Line(points={{-259,-232},{-246,
          ...
          255}));
  connect(yVAVCor, cor.yVAV)
    annotation (Line(points={{480,60},{566,60},{566,50}}, color={0,0,127}));
  connect(VSupCor_flow.V_flow, VCor_flow_SI) annotation (Line(points={{569,130},
          {562,130},{562,148},{610,148}}, color={0,0,127}));
  connect(TSupCor.T, TDisCor_SI) annotation (Line(points={{569,92},{560,92},{
          560,106},{610,106}}, color={0,0,127}));
  annotation (
...
end SystemForMPC_2iInput_modeSignal_Vcore;
