within VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.BaseClasses;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  FakeSystem.ThermalZones.VAVBranch cor(
  ...
  FakeSystem.ThermalZones.VAVBranch sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FakeSystem.ThermalZones.VAVBranch eas(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FakeSystem.ThermalZones.VAVBranch nor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FakeSystem.ThermalZones.VAVBranch wes(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupWes_flow(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={1300,128})));
  FakeSystem.BaseClasses.MixingBox eco(
    redeclare package Medium = MediumA,
