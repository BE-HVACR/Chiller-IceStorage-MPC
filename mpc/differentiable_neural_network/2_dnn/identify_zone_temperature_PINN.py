...
def zone_temp_pcnn(data, features, target, zonNam):
    print(type(features))
    ...
    def build_model(input_shape):
        ...
        model = tf.keras.Sequential([
            ...
            tf.keras.layers.Dense(128, activation='relu', input_shape=input_shape, # activation='softplus'
    ...
    plt.savefig('./results_pcnn/Tz_'+str(zonNam)+'_Tset24_pcnn_scatter.png')
    plt.show()

    # Save the model
    nn_model.save('./results_pcnn/pcnn_model_'+str(zonNam)+'_temperature.h5')

    # To load the model later
    # loaded_model = tf.keras.models.load_model('pcnn_model.h5')
    ...
    plt.savefig('./results_pcnn/Tz_'+str(zonNam)+'_Tset24_pcnn_error.png')
    plt.show()
...
zone_temp_pcnn(data=data, features=features_core, target=target_core, zonNam='core')
# zone_temp_pcnn(data=data, features=features_east, target=target_east, zonNam='east')
# zone_temp_pcnn(data=data, features=features_north, target=target_north, zonNam='north')
# zone_temp_pcnn(data=data, features=features_south, target=target_south, zonNam='south')
# zone_temp_pcnn(data=data, features=features_west, target=target_west, zonNam='west')


##=====open-loop evaluation: the predicted zonal temperature is used to predict the next-step zonal temperature=======
def open_loop_zone_temp_pcnn(model_path, data, features, target, updated_var_name, start_day, num_days, zonNam):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('./results_pcnn//open_loop_test_'+str(zonNam)+'_zone.png')
...
open_loop_zone_temp_pcnn(
    model_path='./results_pcnn/pcnn_model_core_temperature.h5',
    data=data,
...
# open_loop_zone_temp_pcnn(
#     model_path='./results_pcnn/pcnn_model_east_temperature.h5',
#     data=data,
...
# open_loop_zone_temp_pcnn(
#     model_path='./results_pcnn/pcnn_model_north_temperature.h5',
#     data=data,
...
# open_loop_zone_temp_pcnn(
#     model_path='./results_pcnn/pcnn_model_south_temperature.h5',
#     data=data,
...
# open_loop_zone_temp_pcnn(
#     model_path='./results_pcnn/pcnn_model_west_temperature.h5',
#     data=data,
